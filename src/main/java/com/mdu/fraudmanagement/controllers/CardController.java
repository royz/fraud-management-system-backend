...
public class CardController {
    ...
    //delete by fraud id
    @DeleteMapping("/frauds/card/delete")
    ...
    //show all card
    @GetMapping("/frauds/card/all")
    List<Card> getAllCard() {
        return cardService.getAllCard();
    }

    // get card by user_id
    @GetMapping("/frauds/card/{user_id}")
    ...
    @GetMapping("/frauds/card/fraudLevel")
